...
"""
Things to fix/add:
    2. Creation of switches using getOpt or sys.argv
        a. Break each sector into functions and execute based on switches
    3. Handle file modifications -> Don't have to since its a hash based system for awb/acb
    4. Handle file extraction location
        a. Save extraction locaton to file also -> Handle later due to fast push
    √. Initial pull
"""
...
def ADBexec(init=0):   
    ...
    # Time gap to copy and test command later
    # subprocess.call([os.path.realpath(os.path.join(os.getcwd(),'test.bat'))])
    
    # Update latest files by pulling from phone
...
def ACB2WAV():
    ...
    #subprocess.call([os.path.realpath(os.path.join(os.getcwd(),'warning.bat'))])
